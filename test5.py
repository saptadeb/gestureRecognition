# command to run this
# python test5.py --db all_data.npy --labels all_labels.npy --bs 10 --layers 3 --cells 20 --iters 10000 --fracTest 0.2 --nframes 0 --save ./0
...
print "TEST DATA TYPE", testdata.dtype
