# command to run this
# python rnn_lstm_train.py --db all_data.npy --labels all_labels.npy --bs 10 --layers 3 --cells 20 --iters 10000 --output 39 --fracTest 0.2 --load ./model.ckpt --save modelSave.chkpt
