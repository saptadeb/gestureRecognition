# to prepend (add before) nframes (N number of frames) of ZEROS to the data

# command to run this
# python rnn_lstm_test.py --db all_data.npy --labels all_labels.npy --bs 10 --layers 3 --cells 20 --iters 200 --output 39 --fracTest 0.2 --load ./model.ckpt --nframes 1 --save ./1.ckpt
